        ...
        {orders.map((order,index)=>{
          return (
            <div key={order._id} className='order-item'>
              ...
              {/* Order Items Summary and Address - First Column */}
              <div className="order-item-details-col1">
                ...
                {/* User's Full Name */}
                <p className="order-item-user-name">{order.address.firstName} {order.address.lastName}</p> {/* <--- ADDED THIS LINE */}
                {/* User Address and Phone - Stacked Vertically */}
              ...
              {/* Number of Items - Second Column */}
              <div className="order-item-count-col">
                <p>Items: {order.items.length}</p>
              </div>

              {/* Order Amount - Third Column */}
              <div className="order-item-amount-col">
                <p>₹{order.amount}</p>
              </div>

              {/* Status Dropdown - Fourth Column */}
